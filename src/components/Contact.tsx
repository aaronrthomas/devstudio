          ...
          <Card className="border-0 shadow-lg bg-white/95 backdrop-blur">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full text-lg font-semibold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 text-white shadow-lg hover:from-blue-700 hover:to-pink-600 transition-all duration-200"
                  size="lg"
                  disabled={isSubmitting}
                  style={{
                    boxShadow: '0 4px 24px 0 rgba(99,102,241,0.15), 0 1.5px 8px 0 rgba(236,72,153,0.10)'
                  }}
                >
